...
export default async function CustomOrderPage({ params }: { params: Promise<{ locale: "en" | "fa" }> }) {
    ...
    const content = isFa ? {
        subtitle: "سفارش جواهر اختصاصی",
        title1: "جواهر رویایی خود را",
        title2: "از ایده تا واقعیت",
        title3: "بسازید",
        desc: "ما در استودیو AUREL با ترکیب هنر طراحی سه‌بعدی و مهارت استادکاران، منحصربه‌فردترین جواهرات را دقیقاً مطابق با سلیقه و داستان شما خلق می‌کنیم.",
        btnConsult: "شروع مشاوره رایگان",
        btnPortfolio: "مشاهده نمونه‌کارهای ساخته‌شده",

        stats: [
            { icon: "award", value: "۱۵+", label: "سال تجربه" },
            { icon: "gem", value: "۵۰۰۰+", label: "سفارش طراحی" },
            { icon: "users", value: "صدها", label: "مشتری در سراسر ایران" },
            { icon: "shield", value: "رسمی", label: "نماد اعتماد الکترونیکی" },
        ],

        processTitle: "فرآیند شفاف سفارش",
        processDesc: "از اولین ایده تا تحویل نهایی، هر مرحله با شفافیت کامل و تایید شما پیش می‌رود.",
        process: [
            { step: "۰۱", title: "مشاوره رایگان", desc: "ایده، عکس یا طرح ذهنی خود را در واتس‌اپ برای ما ارسال کنید. مشاوره اولیه کاملاً رایگان است." },
            { step: "۰۲", title: "پیش‌پرداخت ۱۰٪ و شروع طراحی", desc: "پس از توافق روی طرح، ۱۰٪ از مبلغ کل به عنوان پیش‌پرداخت دریافت می‌شود و کار طراحی آغاز می‌گردد." },
            { step: "۰۳", title: "تایید مرحله‌ای طراحی", desc: "در هر مرحله از مدلسازی و پرینت نمونه، تصاویر و ویدیو برای شما ارسال و با تایید شما به مرحله بعد می‌رویم." },
            { step: "۰۴", title: "ساخت نهایی در کارگاه", desc: "پس از تایید نهایی نمونه، جواهر شما با بالاترین استانداردها ساخته، عیارکشی و کنترل کیفیت می‌شود." },
            { step: "۰۵", title: "تسویه ۹۰٪ و تحویل", desc: "پس از ارسال تصاویر محصول نهایی، ۹۰٪ باقیمانده تسویه شده و کار به صورت کاملاً بیمه‌شده به دست شما می‌رسد." },
        ],

        trustTitle: "چرا به AUREL اعتماد کنید؟",
        trustDesc: "اعتماد شما، ارزشمندترین سرمایه ماست. ما با شفافیت کامل و پشتوانه‌ی مجوزهای رسمی، در کنار شما هستیم.",
        trust: [
            { title: "تضمین عیار و اصالت", desc: "ارائه فاکتور رسمی معتبر با قید وزن دقیق، عیار استاندارد طلا و سنگ‌ها، به همراه کد T معتبر." },
            { title: "تایید طرح قبل از ساخت", desc: "ارسال رندر سه‌بعدی با جزئیات کامل برای تایید نهایی شما پیش از شروع ساخت." },
            { title: "گارانتی خدمات پس از فروش", desc: "پشتیبانی، آبکاری رایگان و خدمات نگهداری برای اطمینان از درخشش همیشگی." },
            { title: "ارسال کاملاً بیمه‌شده", desc: "بسته‌بندی و ارسال امن و بیمه‌شده به سراسر کشور با کد رهگیری." },
        ],

        credibilityTitle: "پشتوانه‌ی اعتبار ما",
        credibilityDesc: "استودیو AUREL با داشتن مجوزهای رسمی و استقرار در قلب بازار جواهرات تهران، آماده‌ی ارائه‌ی خدمات حرفه‌ای به شماست.",
        enamadTitle: "نماد اعتماد الکترونیکی (اینماد)",
        enamadDesc: "فعالیت ما تحت نظارت و با دارای بودن نماد اعتماد الکترونیکی از سوی وزارت صنعت، معدن و تجارت انجام می‌شود.",
        addressTitle: "حضور فیزیکی در بازار جواهرات تهران",
        addressDesc: "استودیو و کارگاه ما در پاساژ گلشن، چهارراه استانبول تهران مستقر است. شما می‌توانید برای مشاوره حضوری به آدرس ما مراجعه کنید.",
        addressFull: "تهران، چهارراه استانبول، پاساژ گلشن، طبقه اول، واحد 81",

        renderTitle: "آنچه طراحی می‌کنیم، همان است که تحویل می‌گیرید",
        renderLabel1: "طرح سه‌بعدی",
        renderLabel2: "محصول نهایی ساخته‌شده",

        testimonialsTitle: "مشتریان ما چه می‌گویند؟",
        testimonialsSubtitle: "اسکرین‌شات واقعی پیام‌های مشتریانی که به ما اعتماد کردند",

        pricingTitle: "تعرفه شفاف و بدون هزینه پنهان",
        pricing: [
            { value: "۱۸-۲۸٪", title: "اجرت ساخت", desc: "اجرت ساخت بر اساس پیچیدگی طرح محاسبه می‌شود. این مبلغ شامل تمامی مراحل ساخت است." },
            { value: "رایگان", title: "طراحی و مدلسازی", desc: "هزینه طراحی و مدلسازی و پرینت به صورت جداگانه دریافت نمی‌شود و در همان اجرت ساخت لحاظ گردیده است." },
            { value: "۱۰٪", title: "پیش‌پرداخت", desc: "۱۰ درصد از مبلغ کل برای شروع فرآیند طراحی و رزرو زمان کارگاه دریافت می‌شود." },
            { value: "۹۰٪", title: "تسویه نهایی", desc: "۹۰ درصد باقیمانده پس از تکمیل ساخت و ارسال تصاویر محصول نهایی، قبل از ارسال دریافت می‌شود." },
        ],
                                ...
                                <div className="mt-8 flex flex-col items-center gap-3 border-t border-white/10 pt-6">
                                    ...
                                    >
                                        <img
                                            ...
                                            alt="نماد اعتماد الکترونیکی AUREL"
